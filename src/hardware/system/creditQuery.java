...
import static hardware.system.sales.Code;
 ...
 * @author kamau
 */
public class creditQuery extends javax.swing.JFrame {
...
int get;
    /**
     * Creates new form creditQuery
     */
    public creditQuery() {
        initComponents();
    }
public void name(){
String sql = "SELECT `code`, `name`, `tel`, `email` FROM `credit` WHERE `name` like '%"+txtSearch.getText()+"%'";
try{
...
public void Code(){
String sql = "SELECT `code`, `name`, `tel`, `email` FROM `credit` WHERE `code` like '%"+txtSearch.getText()+"%'";
try{
    pst = conn.prepareStatement(sql);
    rs = pst.executeQuery();
    items.setModel(DbUtils.resultSetToTableModel(rs));    
...
public void tel(){
String sql = "SELECT `code`, `name`, `tel`, `email` FROM `credit` WHERE `tel` like '%"+txtSearch.getText()+"%'";
try{
    pst = conn.prepareStatement(sql);
    rs = pst.executeQuery();
    items.setModel(DbUtils.resultSetToTableModel(rs));    
...
JOptionPane.showMessageDialog(null, e);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("<< CLICK TO SELECT DEBTOR>>");
    ...
    private void itemsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_itemsMouseClicked
        ...
        txtname.setText(items.getModel().getValueAt(row, 1).toString());
          int p = JOptionPane.showConfirmDialog(null, "You have selected this debtor '"+txtname.getText()+"' Please OK","Accept",JOptionPane.YES_NO_OPTION);
          if(p==0){CreditCode=txtcode.getText();
          CreditName=txtname.getText();
          this.dispose();
          }
         }
        catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(creditQuery.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new creditQuery().setVisible(true);
            }
        });
    }
